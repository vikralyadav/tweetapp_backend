...
exports.updateTweetRepo =
  exports.createTweetRepo =
  exports.deleteTweetRepo =
  exports.getTweetRepo =
    void 0;
const getTweetRepo = (tweetId) =>
...
const updateTweetRepo = (tweetId, updatedtweet) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const result = yield tweet_model_1.default.findOneAndUpdate(
        { tweetId: tweetId },
        updatedtweet,
        { new: true }
      );
